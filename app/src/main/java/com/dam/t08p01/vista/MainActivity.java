...
public class MainActivity extends AppCompatActivity
    ...
    public void onDlgConfirmacionPositiveClick(DialogFragment dialog) {
        AuthGoogle.getInstance().signOut();
        finish();
    }
    ...
    public void onAceptarLoginFrag(Departamento dpto) {
        // Cerramos LoginFragment
        mLogin = dpto;
        AuthGoogle.getInstance().iniciarSesionUsuarioGoogleAuth(this, mLogin);
    }
    ...
    public void onFailureSignInGoogle() {
        mLogin = null;
        mMainVM.setLogin(null);
        Snackbar.make(findViewById(android.R.id.content), R.string.msg_LoginKO, Snackbar.LENGTH_SHORT).show();
    }
