...
public class MtoDptosFragment extends Fragment {
    ...
    public interface MtoDptosFragInterface {
        ...
        //Departamento antiguo es usado en caso de Editar para eliminarlo de Firebase Authentication
        void onAceptarMtoDptosFrag(int op, Departamento dpto, Departamento dptoAntiguo);
    }
    ...
    private View.OnClickListener btAceptar_OnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (etClave.getText().toString().length() < 6) {
                Snackbar.make(requireActivity().findViewById(android.R.id.content), R.string.msg_ErrorAuthentication6Char, Snackbar.LENGTH_SHORT).show();
            } else {
                if (mListener != null) {
                    if (!etId.getText().toString().equals("") &&
                        ...
                        Departamento antiguoDepartamento = mDpto;
                        ...
                        mListener.onAceptarMtoDptosFrag(mOp, mDpto, antiguoDepartamento);
                    } else {
